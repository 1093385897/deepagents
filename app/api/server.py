...
# output_dir
# D:/.../code/code/app/output/
# 输出目录

# updated_dir
# D:/.../code/code/app/updated/
# 上传暂存目录

# 真正的项目根目录
# D:/.../code/code/
# 包含 pyproject.toml 的目录
...
# ✅ __file__ 是当前文件的路径
# ✅ .resolve() 转换为绝对路径
# ✅ .parent / .parents[n] 获取上级目录
# ✅ .relative_to(base) 计算相对路径
# ✅ / 运算符用于拼接路径
# ✅ 绝对路径给前端和工具使用
# ✅ 相对路径给 AI 模型使用（更安全、更可移植）
...
project_root = current_dir.parent #不是真正的项目根目录，而是 app/ 目录
